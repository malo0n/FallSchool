...
let inputCourse = document.querySelector('.courseInput');
courseUser.forEach(element => {
    addEventListener('change', () => {
        if (element.checked) {
            inputCourse.value = element.value;
...
radioInput.forEach(element => {
    addEventListener('change', () => {
        if (element.checked && element.value == "student") {
            ...
            gradeInput.value = element.value;
...
let inputDegree = document.querySelector('.degreeInput');
let inputFaculty = document.querySelector('.facultyInput');
let inputProgram = document.querySelector('.programInput');
